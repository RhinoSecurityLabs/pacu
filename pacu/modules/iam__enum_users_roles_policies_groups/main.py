...
parser.add_argument(
    ...
    required=False,
    action="store_true",
    help="Enumerate info for users in the account",
)
parser.add_argument(
    "--roles",
    required=False,
    action="store_true",
    help="Enumerate info for roles in the account",
)
parser.add_argument(
    "--policies",
    required=False,
    action="store_true",
    help="Enumerate info for policies in the account",
)
parser.add_argument(
    "--groups",
    required=False,
    action="store_true",
    help="Enumerate info for groups in the account",
)
...
def main(args, pacu_main):
    ...
    if (
        args.users is False
        and args.roles is False
        and args.policies is False
        and args.groups is False
    ):
            ...
            while response is None or is_truncated is True:
                if is_truncated is False:
                    ...
                    response = client.list_policies(
                        Scope="Local", Marker=response["Marker"]
                    )
