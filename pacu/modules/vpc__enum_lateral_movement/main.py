...
def main(args, pacu_main):
    ...
    vpcs_found = 0
    vgw_assoc = {}
    summary_data = {"gateways": 0, "VPNs": 0, "peerings": 0}
        ...
        try:
            ...
            if "directConnectGateways" in gw_response:
                ...
                for dx_gw in gw_response["directConnectGateways"]:
                    ...
                    assoc_response = dx_client.describe_direct_connect_gateway_associations(
                        directConnectGatewayId=dx_gw_id
                    )
                    if "directConnectGatewayAssociations" in assoc_response:
                        for dx_assoc in assoc_response[
                            ...
                            vgw_attachment, vpc_data = get_vpc_by_vgw(
                                pacu_main, vgw_id, vgw_region
                            )
            ...
            if "VpcPeeringConnections" in pcx_response:
                ...
                for pcx in pcx_response["VpcPeeringConnections"]:
                    if pcx["AccepterVpcInfo"]["VpcId"] not in vpcs_by_id:
                        ...
                        vpc_data = get_vpc_by_id(
                            pacu_main,
                            pcx["AccepterVpcInfo"]["VpcId"],
                            pcx["AccepterVpcInfo"]["Region"],
                        )
                        if vpc_data is not None:
                            vpcs_by_id[pcx["AccepterVpcInfo"]["VpcId"]][
                                "VPC"
                            ...
                            vpcs_by_id[pcx["AccepterVpcInfo"]["VpcId"]]["VPC"] = {
                    ...
                    if pcx["RequesterVpcInfo"]["VpcId"] not in vpcs_by_id:
                        ...
                        if vpc_data is not None:
                            ...
                            vpcs_by_id[pcx["RequesterVpcInfo"]["VpcId"]]["VPC"] = {
    ...
    summary_data.update({"vpcs_found": vpcs_found, "vpcs_total": len(session.VPC)})
    return summary_data
