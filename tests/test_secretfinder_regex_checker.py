...
TEST_DATA = [
    ...
    (
        "GitHub token: ghs_1234567890abcdefghijklmnopqrstuvwxyzAB",
        True,
        "GitHub Actions Token",
    ),
    (
        "GitHub token: github_pat_abcdefghijABCDEFGHIJ12_abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567",
        True,
    ...
    (
        "Artifactory Password: AP1ABCDabcdefghijABCDEFGHIJ12",
        True,
    ...
    (
        "Generic API Key: 'api_key' = 'abcdefghijklmnopqrstuvwxyz12345678901234567890ABCDEF\"",
        True,
        "Generic API Key",
    ),
    (
        "Generic Secret: 'secret_key'= '_ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890123456789@$%^&0abcdef\"",
        True,
        "Generic Secret",
    ),
    (
        "Google API Key: AIzaSyC123456789012345678901234567890123",
        True,
        "Google API Key",
    ),
    (
        "Google Cloud Platform API Key: AIzaSyC123456789012345678901234567890123",
        True,
        "Google Cloud Platform API Key",
    ),
    (
        "Google Cloud Platform OAuth: 123456789012-abcd1234abcd1234abcd1234abcd1234.apps.googleusercontent.com",
        True,
        "Google Cloud Platform OAuth",
    ),
    (
        "Google Drive API Key: AIzaSyC123456789012345678901234567890123",
        True,
        "Google Drive API Key",
    ),
    (
        "Google Drive OAuth: 123456789012-abcd1234abcd1234abcd1234abcd1234.apps.googleusercontent.com",
        True,
        "Google Drive OAuth",
    ),
    (
    ...
    (
        "HEROKU API Key: hEroKu_1234567-ABC12345-AB12-CD34-12AB-123456789ABA",
        True,
        "HEROKU_API",
    ),
    ("IPv4 address: 192.168.1.1", True, "IPv4"),
    (
        "MAILGUN API Key: key-abcdefghijklmnopqrstuvwxyz1234567890123456",
        True,
        "MAILGUN_API",
    ),
    ...
    (
        "Slack Webhook: https://hooks.slack.com/services/T12345678/B12345678/abcdefghijklmnopqrstuvwxyz123456",
        True,
        "SLACK_WEBHOOK",
    ),
    ...
    (
        "Twitter Access Token: twitter_1234567890123456789012345678901234567890-1234567890123456789012345678901234567890",
        True,
