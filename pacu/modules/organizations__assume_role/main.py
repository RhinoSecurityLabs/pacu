...
group_accounts.add_argument(
    "--accounts",
    required=False,
    nargs="+",
    default=None,
    help="Pass in a list of accounts to try assuming, --accounts 1 2 3",
)
group_accounts.add_argument(
    "--accounts-file",
    required=False,
    nargs=1,
    default=None,
    help="Pass in a filename containing a list of accounts to try assuming",
)
group_roles.add_argument(
    "--roles",
    required=False,
    nargs="+",
    default=None,
    help="Pass in a list of roles to try assuming. If non are specified uses default OrganizationAccountAccessRole, --roles a b c",
)
group_roles.add_argument(
    "--roles-file",
    required=False,
    nargs=1,
    default=None,
    help="Pass in a filename containing a list of roles to try assuming",
)
