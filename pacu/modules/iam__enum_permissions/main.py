...
def parse_document(document, user):
    ...
    for statement in document["Statement"]:
        ...
        if statement["Effect"] == "Allow":
            ...
            if "Action" in statement and isinstance(
                ...
                for action in statement["Action"]:
                    if action in user["Permissions"]["Allow"]:
                        if isinstance(statement["Resource"], list):
                            ...
                            user["Permissions"]["Allow"][action]["Resources"].append(
                                statement["Resource"]
                            )
                    else:
                        user["Permissions"]["Allow"][action] = {
                        ...
                        if isinstance(resource, list):
                            ...
                            user["Permissions"]["Allow"][action]["Resources"] = [
                                statement["Resource"]
                            ]
                        else:
                            identity = user.get("UserName") or user.get("RoleName")
                            print(
                                "[WARN] No 'Resource' section found. The policy for {} likely contains NotResource "
                                "and our recorded permissions on it will likely be incomplete.".format(
                                    identity
                                )
                            )

                    if "Condition" in statement:
                        user["Permissions"]["Allow"][action]["Conditions"].append(
                            statement["Condition"]
                        )
                    user["Permissions"]["Allow"][action]["Resources"] = list(
                        set(user["Permissions"]["Allow"][action]["Resources"])
                ...
                user["Permissions"]["Allow"][statement["Action"]]["Resources"] = list(
                    set(user["Permissions"]["Allow"][statement["Action"]]["Resources"])
                )  # Remove duplicate resources

            if "NotAction" in statement and isinstance(
        ...
        if statement["Effect"] == "Deny":
            ...
            if "Action" in statement and isinstance(statement["Action"], list):
                ...
                for action in statement["Action"]:
                    if action in user["Permissions"]["Deny"]:
                        if isinstance(statement["Resource"], list):
                            ...
                            user["Permissions"]["Deny"][action]["Resources"].append(
                                statement["Resource"]
                            )
                    else:
                        user["Permissions"]["Deny"][action] = {
                        ...
                        if isinstance(statement["Resource"], list):
                            ...
                            user["Permissions"]["Deny"][action]["Resources"] = [
                                statement["Resource"]
                            ]
                    if "Condition" in statement:
                        user["Permissions"]["Deny"][action]["Conditions"].append(
                            statement["Condition"]
                        )
                    user["Permissions"]["Deny"][action]["Resources"] = list(
                        set(user["Permissions"]["Deny"][action]["Resources"])
                    )  # Remove duplicate resources
                ...
                user["Permissions"]["Deny"][statement["Action"]]["Resources"] = list(
                    set(user["Permissions"]["Deny"][statement["Action"]]["Resources"])
                )  # Remove duplicate resources
