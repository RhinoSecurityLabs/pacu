...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="Enumerate Glue connections.",
)
parser.add_argument(
    "--crawlers",
    required=False,
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="Enumerate Glue development endpoints.",
)
parser.add_argument(
    "--jobs",
    required=False,
...
def main(args, pacu_main):
    ...
    if (
        args.connections is False
        and args.databases is False
        and args.crawlers is False
        and args.jobs is False
        and args.dev_endpoints is False
    ):
        args.connections = (
            args.databases
        ) = args.crawlers = args.jobs = args.dev_endpoints = True
    ...
    for region in regions:
        ...
        # Connections
        if args.connections:
            connections = fetch_glue_data(
                client, "get_connections", "ConnectionList", print
            )
        ...
        if args.dev_endpoints:
            dev_endpoints = fetch_glue_data(
                client, "get_dev_endpoints", "DevEndpoints", print
            )
